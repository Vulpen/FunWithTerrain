...
Mesh MeshTerrain::GenerateTerrainMesh() {
    ...
    for (int z = 0; z < size - 1; z++) {
        for (int x = 0; x <  size - 1; x++) {
            ...
            int colorInd = ind * 24;
            int vertHeight = GetScaledHeightAtPoint(x,z);
            int vertColor = LinearConversion(vertHeight, TERRAIN_MAX * heightScale, 255);
            ...
            vertHeight = GetScaledHeightAtPoint(x,z+1);
            vertColor = LinearConversion(vertHeight, TERRAIN_MAX * heightScale, 255);
            ...
            vertHeight = GetScaledHeightAtPoint(x+1,z);
            vertColor = LinearConversion(vertHeight, TERRAIN_MAX * heightScale, 255);
            ...
            vertHeight = GetScaledHeightAtPoint(x+1,z+1);
            vertColor = LinearConversion(vertHeight, TERRAIN_MAX * heightScale, 255);
